...
CREATE TABLE `movie_link` (
  ...
  PRIMARY KEY (`id`),
  KEY `movie_name` (`movie_name`),
  CONSTRAINT `movie_link_ibfk_1` FOREIGN KEY (`movie_name`) REFERENCES `movie` (`movie_name`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `movie_link`
--

LOCK TABLES `movie_link` WRITE;
/*!40000 ALTER TABLE `movie_link` DISABLE KEYS */;
INSERT INTO `movie_link` VALUES (1,'Annihilation','https://www.imdb.com/title/tt2798920'),(2,'Beauty and the Beast','https://www.imdb.com/title/tt2771200/?ref_=nv_sr_1'),(3,'Lili','https://www.imdb.com/title/tt0046000/'),(4,'War of the Buttons','https://www.imdb.com/title/tt1837587/'),(5,'Mission Impossible - Rogue Nation','https://www.imdb.com/title/tt2381249/?ref_=nv_sr_2'),(6,'Let the Sunshine In','https://www.imdb.com/title/tt6423776/?ref_=nv_sr_1'),(7,'La La Land','https://www.imdb.com/title/tt3783958/?ref_=nv_sr_1'),(8,'Suicide Squad','https://www.imdb.com/title/tt1386697/?ref_=nv_sr_1'),(9,'The Bourne Identity','https://www.imdb.com/title/tt0258463/?ref_=nv_sr_2'),(10,'The Fate of the Furious','https://www.imdb.com/title/tt4630562/?ref_=nv_sr_1'),(11,'Jumanji: Welcome to the Jungle','https://www.imdb.com/title/tt2283362/?ref_=nv_sr_1'),(12,'Titanic','https://www.imdb.com/title/tt0120338/?ref_=nv_sr_1'),(13,'Bus Stop','https://www.imdb.com/title/tt0049038/?ref_=nv_sr_1'),(14,'The Avengers','https://www.imdb.com/title/tt0848228/?ref_=nv_sr_1'),(15,'The Wolf of Wall Street','https://www.imdb.com/title/tt0993846/?ref_=nv_sr_1'),(16,'The Greatest Showman','https://www.imdb.com/title/tt1485796/?ref_=nv_sr_1'),(17,'The Imitation Game','https://www.imdb.com/title/tt2084970/?ref_=nv_sr_1'),(18,'The Canyons','https://www.imdb.com/title/tt2292959/?ref_=nv_sr_1'),(19,'The Martian','https://www.imdb.com/title/tt3659388/?ref_=fn_al_tt_1'),(20,'Forest Gump','https://www.imdb.com/title/tt0109830/?ref_=nv_sr_2'),(21,'Black Panther','https://www.imdb.com/title/tt1825683/?ref_=nv_sr_1'),(22,'Spectre','https://www.imdb.com/title/tt2379713/?ref_=nv_sr_1'),(23,'Shame','https://www.imdb.com/title/tt1723811/?ref_=nv_sr_2'),(24,'Run Lola Run','https://www.imdb.com/title/tt0130827/?ref_=nv_sr_1');
...
-- Dump completed on 2018-04-27 19:47:24
